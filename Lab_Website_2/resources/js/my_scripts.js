...
function loadStatsPage(){
	...
	for (var rowCount = 2; rowCount < table.rows.length; rowCount++){
		awayScore = table.rows[rowCount].cells[awayCol].innerHTML;
		homeScore = table.rows[rowCount].cells[homeCol].innerHTML;
...
function loadPlayersPage() {
	...
	for(var i = 0; i < players.length; i++) {
		options += "<a class = 'dropdown-item' href='#' onclick='switchPlayers(" +i+")'>" + players[i].name + "</a>";
	}

	document.getElementById("player_selector").innerHTML = options;
}
